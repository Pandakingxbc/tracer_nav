...
;//! \htmlinclude TracerBmsStatus.msg.html

(cl:defclass <TracerBmsStatus> (roslisp-msg-protocol:ros-message)
  ((SOC
    :reader SOC
    :initarg :SOC
    :type cl:float
...
(cl:defclass TracerBmsStatus (<TracerBmsStatus>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <TracerBmsStatus>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'TracerBmsStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tracer_msgs-msg:<TracerBmsStatus> is deprecated: use tracer_msgs-msg:TracerBmsStatus instead.")))

(cl:ensure-generic-function 'SOC-val :lambda-list '(m))
(cl:defmethod SOC-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:SOC-val is deprecated.  Use tracer_msgs-msg:SOC instead.")
  (SOC m))

(cl:ensure-generic-function 'SOH-val :lambda-list '(m))
(cl:defmethod SOH-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:SOH-val is deprecated.  Use tracer_msgs-msg:SOH instead.")
  (SOH m))

(cl:ensure-generic-function 'battery_voltage-val :lambda-list '(m))
(cl:defmethod battery_voltage-val ((m <TracerBmsStatus>))
...
(cl:defmethod battery_current-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:battery_current-val is deprecated.  Use tracer_msgs-msg:battery_current instead.")
  (battery_current m))

(cl:ensure-generic-function 'battery_temperature-val :lambda-list '(m))
(cl:defmethod battery_temperature-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:battery_temperature-val is deprecated.  Use tracer_msgs-msg:battery_temperature instead.")
  (battery_temperature m))

(cl:ensure-generic-function 'Alarm_Status_1-val :lambda-list '(m))
(cl:defmethod Alarm_Status_1-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:Alarm_Status_1-val is deprecated.  Use tracer_msgs-msg:Alarm_Status_1 instead.")
  (Alarm_Status_1 m))

(cl:ensure-generic-function 'Alarm_Status_2-val :lambda-list '(m))
(cl:defmethod Alarm_Status_2-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:Alarm_Status_2-val is deprecated.  Use tracer_msgs-msg:Alarm_Status_2 instead.")
  (Alarm_Status_2 m))

(cl:ensure-generic-function 'Warning_Status_1-val :lambda-list '(m))
(cl:defmethod Warning_Status_1-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:Warning_Status_1-val is deprecated.  Use tracer_msgs-msg:Warning_Status_1 instead.")
  (Warning_Status_1 m))

(cl:ensure-generic-function 'Warning_Status_2-val :lambda-list '(m))
(cl:defmethod Warning_Status_2-val ((m <TracerBmsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tracer_msgs-msg:Warning_Status_2-val is deprecated.  Use tracer_msgs-msg:Warning_Status_2 instead.")
  (Warning_Status_2 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TracerBmsStatus>) ostream)
  "Serializes a message object of type '<TracerBmsStatus>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TracerBmsStatus>) istream)
  "Deserializes a message object of type '<TracerBmsStatus>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TracerBmsStatus>)))
  "Returns string type for a message object of type '<TracerBmsStatus>"
  "tracer_msgs/TracerBmsStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TracerBmsStatus)))
  "Returns string type for a message object of type 'TracerBmsStatus"
  "tracer_msgs/TracerBmsStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TracerBmsStatus>)))
  "Returns md5sum for a message object of type '<TracerBmsStatus>"
  "8825e008639377a676911a7ad9d079ce")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TracerBmsStatus)))
  "Returns md5sum for a message object of type 'TracerBmsStatus"
  "8825e008639377a676911a7ad9d079ce")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TracerBmsStatus>)))
  "Returns full string definition for message of type '<TracerBmsStatus>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TracerBmsStatus)))
  "Returns full string definition for message of type 'TracerBmsStatus"
  (cl:format cl:nil "#BMS date~%float64 SOC~%float64 SOH~%float64 battery_voltage~%float64 battery_current~%float64 battery_temperature~%~%#BMS status~%uint8 Alarm_Status_1~%uint8 Alarm_Status_2~%uint8 Warning_Status_1~%uint8 Warning_Status_2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <TracerBmsStatus>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TracerBmsStatus>))
  "Converts a ROS message object to a list"
  (cl:list 'TracerBmsStatus
    (cl:cons ':SOC (SOC msg))
    (cl:cons ':SOH (SOH msg))
