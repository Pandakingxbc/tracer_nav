...
class TracerBmsStatus {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.SOH, buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'tracer_msgs/TracerBmsStatus';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TracerBmsStatus(null);
...
module.exports = TracerBmsStatus;
